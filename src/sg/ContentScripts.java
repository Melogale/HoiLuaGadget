...
public class ContentScripts {
    ...
    public static HashMap<Integer, Integer> getVPs(String content) {
        ...
        HashMap<Integer, Integer> vps = new HashMap<Integer, Integer>();
    ...
    public static ArrayList<ProvinceBuildings> getProvinceBuildings(String content) {
        ...
        ArrayList<Integer> forts = ParsingScripts.findIndexesOfExceptWhenFollowing(content, fort, "coastal_");
